...
STYLE = """
body { font-family: 'Segoe UI', Arial, sans-serif; background-color: #0f172a; color: #ffffff; margin: 0; padding: 2rem; }
.container { max-width: 800px; margin: 0 auto; background: #1e293b; border-radius: 16px; box-shadow: 0 20px 45px rgba(15,23,42,0.6); padding: 2.5rem; color: #ffffff; }
h1 { color: #38bdf8; margin-bottom: 0.5rem; }
h2 { color: #f472b6; border-bottom: 1px solid rgba(148,163,184,0.3); padding-bottom: 0.25rem; }
p, li { line-height: 1.6; color: #ffffff; }
ul { padding-left: 1.5rem; }
strong { color: #fbbf24; }
blockquote { border-left: 4px solid #38bdf8; margin: 1rem 0; padding-left: 1rem; color: #ffffff; }
...
section { margin-bottom: 1.5rem; padding: 1rem; border-radius: 12px; background: rgba(148,163,184,0.1); color: #ffffff; }
footer { text-align: center; font-size: 0.85rem; color: #d4dbe6; margin-top: 2rem; }
"""
